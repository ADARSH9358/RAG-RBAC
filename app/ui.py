...
import os
import sys
import streamlit as st  # <-- MAKE SURE THIS LINE IS HERE
from requests.auth import HTTPBasicAuth
import base64
import requests

# 1. Automatically launch your backend inside the same container
@st.cache_resource
...
# Start the background backend
start_backend_server()

# Keep localhost since the backend is now running right next to Streamlit!
